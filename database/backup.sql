...
(1,'Perro','2023-10-04 20:20:33',NULL,'1'),
(2,'Gato','2023-10-04 20:20:33',NULL,'1');
...
(1,'Luque Ramos','Johan Alberto','71789712','$2y$10$Cnti6nMp5glSTbDRJy9bAOHWeYXI5uRSvEcKnKFMA8qU2D6jJFNCW','2023-10-04 20:20:33',NULL,'1'),
(2,'Quispe Acevedo','Piero','12345678','$2y$10$Cnti6nMp5glSTbDRJy9bAOHWeYXI5uRSvEcKnKFMA8qU2D6jJFNCW','2023-10-04 20:20:33',NULL,'1'),
(3,'Polo Andrade','Andy Smith','12345677','$2y$10$Cnti6nMp5glSTbDRJy9bAOHWeYXI5uRSvEcKnKFMA8qU2D6jJFNCW','2023-10-04 20:20:33',NULL,'1'),
(4,'Corzo Carbajal','Aldo Alfredo','12345666','$2y$10$Cnti6nMp5glSTbDRJy9bAOHWeYXI5uRSvEcKnKFMA8qU2D6jJFNCW','2023-10-04 20:20:33',NULL,'1');
...
(1,'Carrizo','perro1.jpg','Negro y Rubio','H',1,4),
(2,'Blanca','perro2.jpg','Blanco','H',1,6),
(3,'Conejo','gato2.jpg','Rubio','M',2,8),
(4,'sofi','oerro1.jpg','Rubio','H',2,3),
(5,'Garfield','gato3.jpg','Rubio','M',2,12);
...
(1,'Schnauser',1,'2023-10-04 20:20:33',NULL,'1'),
(2,'Dalmata',1,'2023-10-04 20:20:33',NULL,'1'),
(3,'American Bully',1,'2023-10-04 20:20:33',NULL,'1'),
(4,'Pastor aleman',1,'2023-10-04 20:20:33',NULL,'1'),
(5,'Pit bull',1,'2023-10-04 20:20:33',NULL,'1'),
(6,'Mestizo',1,'2023-10-04 20:20:33',NULL,'1'),
(7,'Chinchilla',2,'2023-10-04 20:20:33',NULL,'1'),
(8,'Devon Rex',2,'2023-10-04 20:20:33',NULL,'1'),
(9,'Korat',2,'2023-10-04 20:20:33',NULL,'1'),
(10,'Oriental de pelo largo',2,'2023-10-04 20:20:33',NULL,'1'),
(11,'Ragdoll',2,'2023-10-04 20:20:33',NULL,'1'),
(12,'Ocigato',2,'2023-10-04 20:20:33',NULL,'1');
...
/* Procedure structure for procedure `spu_listar_Animal` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_listar_Animal` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_listar_Animal`()
BEGIN 
...
/* Procedure structure for procedure `spu_listar_mascotas` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_listar_mascotas` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_listar_mascotas`(
	IN _idcliente 	INT
)
BEGIN
...
/* Procedure structure for procedure `spu_listar_razas` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_listar_razas` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_listar_razas`( IN _id INT)
BEGIN
	SELECT idraza, 
	nombreRaza 
	FROM razas
